...
void logging::Logger::open(const std::filesystem::path& log_file_path)
{
...
std::filesystem::path logging::Logger::log_id_file_path() const
{
...
bool logging::Logger::is_max_log_reached()
{
    if (!_log_file.is_open())
        return false;
